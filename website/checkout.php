...
if (isset($_POST['sub'])) {
    ...
    if (empty($num_cartao)) {
        $query = "insert into `pedidos` (data_pedido, data_entrega, id_conta, endereco, cidade, pais, num_cartao, total) values(CURDATE(), NULL, '$id_conta', '$end', '$cidade', '$pais', NULL, 0)";
    } else {
        ...
        $query = "insert into `pedidos` (data_pedido, data_entrega, id_conta, endereco, cidade, pais, num_cartao, total) values(CURDATE(), NULL, '$id_conta', '$end', '$cidade', '$pais', '$num_cartao', 0)";
    }
    ...
    <div class="container">
        ...
        <div class="d-flex">
            <form method="post" id="form1">
                ...
                <input class="input11" type="text" name="pais" placeholder="Estado" maxlength="2" required>
